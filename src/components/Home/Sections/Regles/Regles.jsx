...
const rules = [
    ...
    },
    {
        ...
        description: [
            ...
            "Notez dans votre fiche d’enquête, les indices que vous trouvez au fur et à mesure dans votre fiche d’enquête. Ce livret rouge et les reproductions des œuvres sont consultables tout au long de la partie. Profitez des moments en dehors de votre tour pour lire le livret et regarder les œuvres.",
